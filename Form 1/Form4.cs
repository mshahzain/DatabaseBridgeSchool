...
namespace Form_1
{
    public partial class Form4 : Form
    {
        ...
        private void AddDataToComboBox()
        {
            ...
            string Sql = "Select StudentName from Students where Class like '" +comboBox2.Text+"' Order by StudentName";
        ...
        private void Button1_Click(object sender, EventArgs e)
        {
            ...
            if (comboBox1.SelectedItem != null)
            {
                ...
                connectionString = "Data Source = DESKTOP-VEVG9RB; Initial Catalog = Khidmat; Integrated Security = True";
                cnn = new SqlConnection(connectionString);
                string Sql = "Select * from Students where Class like '" + comboBox2.Text +"' and StudentName = '" + temp + "' "  ;
                cnn.Open();
        ...
        private void Button7_Click(object sender, EventArgs e)
        {
            ...
            {
                string updateQuery = "UPDATE Students Set StudentName ='" + textBox6.Text + "',Class ='" +
                    textBox10.Text + "', FatherName ='" + textBox3.Text + "', MotherName ='" +
                    textBox4.Text + "',ContactNo ='" + textBox5.Text + "' ,DOB ='" + textBox7.Text + "' , Attitude ='" +
                    textBox9.Text + "' ,Address ='" + textBox8.Text + "' WHERE StudentName = '" + comboBox1.Text + "'";
            ...
            else
            {
                if (textBox10.Text != "" && textBox6.Text != "")
                {
                    ...
                    sq_reader.Close();
                    string addQuery = "Insert into Students (ID, StudentName, FatherName, Class, ContactNo, DOB, MotherName, Attitude, Address) " 
                      +
                       "values('" + textBox2.Text + "', '" + textBox6.Text +
                       "', '" + textBox3.Text + "', '" + textBox10.Text + "', '" 
                       + textBox5.Text + "', '"
                       + textBox7.Text + "', '" + textBox4.Text + "', '" + textBox8.Text + "', '" + textBox9.Text + "')";
